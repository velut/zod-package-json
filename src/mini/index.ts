/**
This package exports a zod mini schema (and a TypeScript type) named `PackageJson`
...
If necessary, that can be done by extending the schema with zod mini methods.
